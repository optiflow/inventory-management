export default {
  ...
  inventory: {
    ...
    stockLevels: "在庫レベル",
    skus: "SKU",
    searchPlaceholder: "SKU、品目、カテゴリ、場所、ステータスを検索...",
    clearSearch: "検索をクリア",
    exportCsv: "CSVをエクスポート",
    lowStockAlertTitle: "在庫僅少品目が{count}件あります",
    lowStockAlertDescription:
      "現在のフィルターで、これらの品目は再注文点以下です。",
    lowStockShortfall: "{count}不足",
    lowStockMore: "他に在庫僅少品目が{count}件あります",
    atReorderPoint: "再注文点",
    dismissLowStockAlert: "在庫僅少アラートを閉じる",
    emptyInventory: "現在のフィルターに一致する在庫品目はありません",
    emptySearchResults: "一致する在庫品目はありません",
    emptySearchHint: "検索語をクリアまたは変更してください。",
    totalItems: "総品目数",
    totalValue: "総価値",
