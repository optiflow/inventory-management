export default {
  ...
  inventory: {
    ...
    skus: "SKUs",
    searchPlaceholder: "Search SKU, item, category, location, or status...",
    clearSearch: "Clear search",
    exportCsv: "Export CSV",
    lowStockAlertTitle: "{count} low-stock items need attention",
    lowStockAlertDescription:
      "These items are at or below their reorder point for the current filters.",
    lowStockShortfall: "Short by {count}",
    lowStockMore: "{count} more low-stock items",
    atReorderPoint: "At reorder point",
    dismissLowStockAlert: "Dismiss low-stock alert",
    emptyInventory: "No inventory items match the current filters",
    emptySearchResults: "No matching inventory items",
    emptySearchHint: "Clear or change the search term.",
